...
const SETTINGS_TEXTS = {
  ...
  de: {
    ...
    page: {
      ...
      keyboardLayoutFr: "Franzoesisch AZERTY",
      keyboardLayoutEs: "Spanisch QWERTY",
      privacyData: "Privatsphäre und Daten",
      saveRuns: "Runs im Konto speichern",
      saveErrorWords: "Detaillierte Fehlerwoerter speichern",
      showErrorBreakdownPrivacy: "Fehleraufschluesselung nach Runs anzeigen",
      deleteSavedData: "Gespeicherte Tippdaten loeschen",
      deletingSavedData: "Loesche...",
      savedDataDeleted: "Gespeicherte Daten geloescht",
      loginToDeleteData: "Logge dich ein, um gespeicherte Kontodaten zu loeschen.",
      deleteSavedDataTitle: "Gespeicherte Tippdaten loeschen?",
      deleteSavedDataDescription: "Das entfernt gespeicherte Runs und detaillierte Fehlerwoerter aus deinem Konto. Das kann nicht rueckgaengig gemacht werden.",
      confirmDeleteSavedData: "Daten loeschen",
      deleteSavedDataFailed: "Gespeicherte Daten konnten nicht geloescht werden.",
...
const TYPING_GAME_TEXTS = {
  ...
  de: {
    ...
    saveDisabled: "Speichern ist unter Privatsphaere und Daten ausgeschaltet.",
    ...
    restartHint: "Druecke {key}, um nochmal zu spielen.",
