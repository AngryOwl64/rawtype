...
const APP_TEXTS = {
  en: {
    ...
    home: {
      ...
      customModeDescription: "Generated practice with custom text shape controls.",
      customLetterFocus: "Letter Focus",
      customFocusBalanced: "Balanced",
      customFocusHomeRow: "Home Row",
      customFocusTopRow: "Top Row",
      customFocusLeftHand: "Left Hand",
      customFocusRightHand: "Right Hand",
      customCasing: "Casing",
      customCasingNatural: "Natural",
      customCasingLowercase: "Lowercase",
      customCasingUppercase: "Uppercase",
      customCasingTitle: "Title Case",
      customPunctuation: "Punctuation",
      customNumbers: "Numbers",
      customSymbols: "Symbols",
      customRepeats: "Repeats",
      customLevelNone: "None",
      customLevelLight: "Light",
      customLevelDense: "Dense",
      customRhythm: "Rhythm",
      customRhythmSteady: "Steady",
      customRhythmBursts: "Bursts",
      customRhythmStaggered: "Staggered",
      customPinnedWords: "Pinned Words",
      customPinnedWordsPlaceholder: "react, query, cache",
      startCustomMode: "Start Custom Mode"
    },
    gameHeader: {
      title: "Classic mode",
      wordsLabel: "Words",
  ...
  de: {
    ...
    home: {
      ...
      classicDescription: "Modus mit zufälligen Texten",
      startClassic: "start",
      wordModeTitle: "Wortmodus",
      wordModeDescription: "Zufällig generierte Wörter",
      ...
      wordsSuffix: "Wörter",
      startWordMode: "start",
      customModeTitle: "Custom Modus",
      customModeDescription: "Passe alles an",
      customLetterFocus: "Buchstabenfokus",
      customFocusBalanced: "Ausgewogen",
      customFocusHomeRow: "Grundreihe",
      customFocusTopRow: "Obere Reihe",
      customFocusLeftHand: "Linke Hand",
      customFocusRightHand: "Rechte Hand",
      customCasing: "Groß-/Kleinschreibung",
      customCasingNatural: "Natürlich",
      customCasingLowercase: "Kleinbuchstaben",
      customCasingUppercase: "Großbuchstaben",
      customCasingTitle: "Jedes Wort groß",
      customPunctuation: "Satzzeichen",
      customNumbers: "Zahlen",
      customSymbols: "Symbole",
      customRepeats: "Wiederholungen",
      customLevelNone: "Keine",
      customLevelLight: "Wenig",
      customLevelDense: "Viel",
      customRhythm: "Rhythmus",
      customRhythmSteady: "Gleichmäßig",
      customRhythmBursts: "In Blöcken",
      customRhythmStaggered: "Abwechselnd",
      customPinnedWords: "zusätzliche Wörter",
      customPinnedWordsPlaceholder: "Schmarn, Bayern, ...",
      startCustomMode: "start"
    },
    gameHeader: {
      title: "Classic Modus",
      wordsLabel: "Wörter",
...
const SETTINGS_TEXTS = {
  en: {
    ...
    page: {
      ...
      focusModeAll: "All Words",
      focusModeColumns: "Columns",
      focusModeRow: "Left To Right",
      focusModePreview: "Focus Mode Preview",
      ...
      metricValueAnimation: "Number Changes",
      metricValueRollUp: "Roll",
      metricValueSlideSide: "Glide",
      metricValueFlip: "Flip",
  ...
  de: {
    ...
    themeSection: {
      title: "Theme",
      active: "Aktiv",
      openWindow: "Theme-Fenster"
    },
    page: {
      title: "Einstellungen",
      preview: "Vorschau",
      settingsCategories: "Einstellungskategorien",
      appearance: "Standart Spieleinstellungen",
      typing: "Tippen",
      animations: "Animationen",
      generalSettings: "Allgemeine Einstellungen",
      language: "Website Sprache",
      generalFont: "Website Font",
      textFont: "Game Font",
      typingDefaults: "Standartsettings",
      mode: "Modus",
      modeSentences: "Sätze",
      modeWords: "Wörter",
      modeCustom: "Eigener Modus",
      ...
      focusModeAll: "Alles wie jetzt",
      focusModeColumns: "Spaltenweise",
      focusModeRow: "Von links nach rechts",
      focusModePreview: "Fokusmodus-Vorschau",
      ...
      metricValueAnimation: "Zahlenwechsel",
      metricValueRollUp: "Rollen",
      metricValueSlideSide: "Gleiten",
      metricValueFlip: "Umklappen",
...
const TYPING_GAME_TEXTS = {
  en: {
    ...
    loadingCustom: "Generating custom practice...",
  ...
  de: {
    ...
    loadingCustom: "Eigene Übung wird erzeugt...",
